...
export const useIngredientStore = create<IngredientState>((set) => ({
    ...
    loadIngredients: async () => {
        ...
        try {
            ...
            set({error: "Помилка при завантаженні інгредіентів", isLoading: false});
        }
    },
    addIngredient: async (formData: FormData) => {
        ...
        try {
            ...
            console.error("error", error);
            set({error: "Помилка прі додаванні інгрідієнта", isLoading: false});
        }
    },
    removeIngredient: async (id: string) => {
        ...
        try {
            ...
            console.error("error", error);
            set({error: "Помилка при видаленні інгредієнта", isLoading: false});
        }
    },
}));
